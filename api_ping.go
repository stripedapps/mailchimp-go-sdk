...
func (r ApiGetPingRequest) Execute() (*APIHealthStatus, *http.Response, error) {
...
func (a *PingAPIService) GetPingExecute(r ApiGetPingRequest) (*APIHealthStatus, *http.Response, error) {
	var (
