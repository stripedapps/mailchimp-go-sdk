...
// checks if the AddListMembers2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddListMembers2{}

// AddListMembers2 Individuals who are currently or have been previously subscribed to this list, including members who have bounced or unsubscribed.
type AddListMembers2 struct {
...
// NewAddListMembers2 instantiates a new AddListMembers2 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAddListMembers2(emailAddress string, statusIfNew string) *AddListMembers2 {
	this := AddListMembers2{}
	this.EmailAddress = emailAddress
	this.StatusIfNew = statusIfNew
	return &this
}

// NewAddListMembers2WithDefaults instantiates a new AddListMembers2 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAddListMembers2WithDefaults() *AddListMembers2 {
	this := AddListMembers2{}
	return &this
}

// GetEmailAddress returns the EmailAddress field value
func (o *AddListMembers2) GetEmailAddress() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *AddListMembers2) GetEmailAddressOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AddListMembers2) SetEmailAddress(v string) {
	o.EmailAddress = v
}

// GetStatusIfNew returns the StatusIfNew field value
func (o *AddListMembers2) GetStatusIfNew() string {
	if o == nil {
		var ret string
		return ret
	}

	return o.StatusIfNew
}

// GetStatusIfNewOk returns a tuple with the StatusIfNew field value
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetStatusIfNewOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.StatusIfNew, true
}

// SetStatusIfNew sets field value
func (o *AddListMembers2) SetStatusIfNew(v string) {
	o.StatusIfNew = v
}

// GetEmailType returns the EmailType field value if set, zero value otherwise.
func (o *AddListMembers2) GetEmailType() string {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetEmailTypeOk() (*string, bool) {
	if o == nil || IsNil(o.EmailType) {
		return nil, false
	}
...
func (o *AddListMembers2) SetEmailType(v string) {
	o.EmailType = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *AddListMembers2) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *AddListMembers2) SetStatus(v string) {
	o.Status = &v
}

// GetMergeFields returns the MergeFields field value if set, zero value otherwise.
func (o *AddListMembers2) GetMergeFields() map[string]map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetMergeFieldsOk() (map[string]map[string]interface{}, bool) {
	if o == nil || IsNil(o.MergeFields) {
...
func (o *AddListMembers2) SetMergeFields(v map[string]map[string]interface{}) {
	o.MergeFields = v
}

// GetInterests returns the Interests field value if set, zero value otherwise.
func (o *AddListMembers2) GetInterests() map[string]bool {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetInterestsOk() (*map[string]bool, bool) {
	if o == nil || IsNil(o.Interests) {
		return nil, false
	}
...
func (o *AddListMembers2) SetInterests(v map[string]bool) {
	o.Interests = &v
}

// GetLanguage returns the Language field value if set, zero value otherwise.
func (o *AddListMembers2) GetLanguage() string {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetLanguageOk() (*string, bool) {
	if o == nil || IsNil(o.Language) {
		return nil, false
	}
...
func (o *AddListMembers2) SetLanguage(v string) {
	o.Language = &v
}

// GetVip returns the Vip field value if set, zero value otherwise.
func (o *AddListMembers2) GetVip() bool {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetVipOk() (*bool, bool) {
	if o == nil || IsNil(o.Vip) {
		return nil, false
	}
	return o.Vip, true
...
func (o *AddListMembers2) SetVip(v bool) {
	o.Vip = &v
}

// GetLocation returns the Location field value if set, zero value otherwise.
func (o *AddListMembers2) GetLocation() Location {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetLocationOk() (*Location, bool) {
	if o == nil || IsNil(o.Location) {
		return nil, false
	}
...
func (o *AddListMembers2) SetLocation(v Location) {
	o.Location = &v
}

// GetMarketingPermissions returns the MarketingPermissions field value if set, zero value otherwise.
func (o *AddListMembers2) GetMarketingPermissions() []MarketingPermission1 {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetMarketingPermissionsOk() ([]MarketingPermission1, bool) {
	if o == nil || IsNil(o.MarketingPermissions) {
		return nil, false
	}
...
func (o *AddListMembers2) SetMarketingPermissions(v []MarketingPermission1) {
	o.MarketingPermissions = v
}

// GetIpSignup returns the IpSignup field value if set, zero value otherwise.
func (o *AddListMembers2) GetIpSignup() string {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetIpSignupOk() (*string, bool) {
	if o == nil || IsNil(o.IpSignup) {
		return nil, false
	}
...
func (o *AddListMembers2) SetIpSignup(v string) {
	o.IpSignup = &v
}

// GetTimestampSignup returns the TimestampSignup field value if set, zero value otherwise.
func (o *AddListMembers2) GetTimestampSignup() time.Time {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetTimestampSignupOk() (*time.Time, bool) {
	if o == nil || IsNil(o.TimestampSignup) {
		return nil, false
	}
...
func (o *AddListMembers2) SetTimestampSignup(v time.Time) {
	o.TimestampSignup = &v
}

// GetIpOpt returns the IpOpt field value if set, zero value otherwise.
func (o *AddListMembers2) GetIpOpt() string {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetIpOptOk() (*string, bool) {
	if o == nil || IsNil(o.IpOpt) {
		return nil, false
	}
	return o.IpOpt, true
...
func (o *AddListMembers2) SetIpOpt(v string) {
	o.IpOpt = &v
}

// GetTimestampOpt returns the TimestampOpt field value if set, zero value otherwise.
func (o *AddListMembers2) GetTimestampOpt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers2) GetTimestampOptOk() (*time.Time, bool) {
	if o == nil || IsNil(o.TimestampOpt) {
		return nil, false
	}
...
func (o *AddListMembers2) SetTimestampOpt(v time.Time) {
	o.TimestampOpt = &v
}

func (o AddListMembers2) MarshalJSON() ([]byte, error) {
...
func (o AddListMembers2) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["email_address"] = o.EmailAddress
	toSerialize["status_if_new"] = o.StatusIfNew
...
type NullableAddListMembers2 struct {
	value *AddListMembers2
	isSet bool
}

func (v NullableAddListMembers2) Get() *AddListMembers2 {
	return v.value
}

func (v *NullableAddListMembers2) Set(val *AddListMembers2) {
	v.value = val
	v.isSet = true
}

func (v NullableAddListMembers2) IsSet() bool {
	return v.isSet
}

func (v *NullableAddListMembers2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddListMembers2(val *AddListMembers2) *NullableAddListMembers2 {
	return &NullableAddListMembers2{value: val, isSet: true}
}

func (v NullableAddListMembers2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddListMembers2) UnmarshalJSON(src []byte) error {
	v.isSet = true
