...
// checks if the AddListMembers3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddListMembers3{}

// AddListMembers3 Individuals who are currently or have been previously subscribed to this list, including members who have bounced or unsubscribed.
...
// NewAddListMembers3 instantiates a new AddListMembers3 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAddListMembers3() *AddListMembers3 {
	this := AddListMembers3{}
	return &this
}

// NewAddListMembers3WithDefaults instantiates a new AddListMembers3 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAddListMembers3WithDefaults() *AddListMembers3 {
	this := AddListMembers3{}
	return &this
}

// GetEmailAddress returns the EmailAddress field value if set, zero value otherwise.
func (o *AddListMembers3) GetEmailAddress() string {
...
func (o *AddListMembers3) GetEmailAddressOk() (*string, bool) {
	if o == nil || IsNil(o.EmailAddress) {
		return nil, false
	}
...
func (o *AddListMembers3) HasEmailAddress() bool {
	if o != nil && !IsNil(o.EmailAddress) {
		return true
	}
...
func (o *AddListMembers3) SetEmailAddress(v string) {
	o.EmailAddress = &v
}

// GetEmailType returns the EmailType field value if set, zero value otherwise.
func (o *AddListMembers3) GetEmailType() string {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetEmailTypeOk() (*string, bool) {
	if o == nil || IsNil(o.EmailType) {
		return nil, false
	}
...
func (o *AddListMembers3) HasEmailType() bool {
	if o != nil && !IsNil(o.EmailType) {
		return true
	}
...
func (o *AddListMembers3) SetEmailType(v string) {
	o.EmailType = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *AddListMembers3) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *AddListMembers3) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *AddListMembers3) SetStatus(v string) {
	o.Status = &v
}

// GetMergeFields returns the MergeFields field value if set, zero value otherwise.
func (o *AddListMembers3) GetMergeFields() map[string]map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetMergeFieldsOk() (map[string]map[string]interface{}, bool) {
	if o == nil || IsNil(o.MergeFields) {
...
func (o *AddListMembers3) HasMergeFields() bool {
	if o != nil && !IsNil(o.MergeFields) {
		return true
	}
...
func (o *AddListMembers3) SetMergeFields(v map[string]map[string]interface{}) {
	o.MergeFields = v
}

// GetInterests returns the Interests field value if set, zero value otherwise.
func (o *AddListMembers3) GetInterests() map[string]bool {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetInterestsOk() (*map[string]bool, bool) {
	if o == nil || IsNil(o.Interests) {
		return nil, false
	}
...
func (o *AddListMembers3) HasInterests() bool {
	if o != nil && !IsNil(o.Interests) {
		return true
	}
...
func (o *AddListMembers3) SetInterests(v map[string]bool) {
	o.Interests = &v
}

// GetLanguage returns the Language field value if set, zero value otherwise.
func (o *AddListMembers3) GetLanguage() string {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetLanguageOk() (*string, bool) {
	if o == nil || IsNil(o.Language) {
		return nil, false
	}
...
func (o *AddListMembers3) HasLanguage() bool {
	if o != nil && !IsNil(o.Language) {
		return true
	}
...
func (o *AddListMembers3) SetLanguage(v string) {
	o.Language = &v
}

// GetVip returns the Vip field value if set, zero value otherwise.
func (o *AddListMembers3) GetVip() bool {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetVipOk() (*bool, bool) {
	if o == nil || IsNil(o.Vip) {
		return nil, false
	}
	return o.Vip, true
...
func (o *AddListMembers3) HasVip() bool {
	if o != nil && !IsNil(o.Vip) {
		return true
	}
...
func (o *AddListMembers3) SetVip(v bool) {
	o.Vip = &v
}

// GetLocation returns the Location field value if set, zero value otherwise.
func (o *AddListMembers3) GetLocation() Location {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetLocationOk() (*Location, bool) {
	if o == nil || IsNil(o.Location) {
		return nil, false
	}
...
func (o *AddListMembers3) HasLocation() bool {
	if o != nil && !IsNil(o.Location) {
		return true
	}
...
func (o *AddListMembers3) SetLocation(v Location) {
	o.Location = &v
}

// GetMarketingPermissions returns the MarketingPermissions field value if set, zero value otherwise.
func (o *AddListMembers3) GetMarketingPermissions() []MarketingPermission1 {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetMarketingPermissionsOk() ([]MarketingPermission1, bool) {
	if o == nil || IsNil(o.MarketingPermissions) {
		return nil, false
	}
...
func (o *AddListMembers3) HasMarketingPermissions() bool {
	if o != nil && !IsNil(o.MarketingPermissions) {
		return true
	}
...
func (o *AddListMembers3) SetMarketingPermissions(v []MarketingPermission1) {
	o.MarketingPermissions = v
}

// GetIpSignup returns the IpSignup field value if set, zero value otherwise.
func (o *AddListMembers3) GetIpSignup() string {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetIpSignupOk() (*string, bool) {
	if o == nil || IsNil(o.IpSignup) {
		return nil, false
	}
...
func (o *AddListMembers3) HasIpSignup() bool {
	if o != nil && !IsNil(o.IpSignup) {
		return true
	}
...
func (o *AddListMembers3) SetIpSignup(v string) {
	o.IpSignup = &v
}

// GetTimestampSignup returns the TimestampSignup field value if set, zero value otherwise.
func (o *AddListMembers3) GetTimestampSignup() time.Time {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetTimestampSignupOk() (*time.Time, bool) {
	if o == nil || IsNil(o.TimestampSignup) {
		return nil, false
	}
...
func (o *AddListMembers3) HasTimestampSignup() bool {
	if o != nil && !IsNil(o.TimestampSignup) {
		return true
	}
...
func (o *AddListMembers3) SetTimestampSignup(v time.Time) {
	o.TimestampSignup = &v
}

// GetIpOpt returns the IpOpt field value if set, zero value otherwise.
func (o *AddListMembers3) GetIpOpt() string {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetIpOptOk() (*string, bool) {
	if o == nil || IsNil(o.IpOpt) {
		return nil, false
	}
	return o.IpOpt, true
...
func (o *AddListMembers3) HasIpOpt() bool {
	if o != nil && !IsNil(o.IpOpt) {
		return true
	}
...
func (o *AddListMembers3) SetIpOpt(v string) {
	o.IpOpt = &v
}

// GetTimestampOpt returns the TimestampOpt field value if set, zero value otherwise.
func (o *AddListMembers3) GetTimestampOpt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *AddListMembers3) GetTimestampOptOk() (*time.Time, bool) {
	if o == nil || IsNil(o.TimestampOpt) {
		return nil, false
	}
...
func (o *AddListMembers3) HasTimestampOpt() bool {
	if o != nil && !IsNil(o.TimestampOpt) {
		return true
	}
...
func (o *AddListMembers3) SetTimestampOpt(v time.Time) {
	o.TimestampOpt = &v
}

func (o AddListMembers3) MarshalJSON() ([]byte, error) {
...
func (o AddListMembers3) ToMap() (map[string]interface{}, error) {
...
type NullableAddListMembers3 struct {
	value *AddListMembers3
	isSet bool
}

func (v NullableAddListMembers3) Get() *AddListMembers3 {
	return v.value
}

func (v *NullableAddListMembers3) Set(val *AddListMembers3) {
	v.value = val
	v.isSet = true
}

func (v NullableAddListMembers3) IsSet() bool {
	return v.isSet
}

func (v *NullableAddListMembers3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddListMembers3(val *AddListMembers3) *NullableAddListMembers3 {
	return &NullableAddListMembers3{value: val, isSet: true}
}

func (v NullableAddListMembers3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddListMembers3) UnmarshalJSON(src []byte) error {
	v.isSet = true
